...
TEST_CASE("Ohmic memory kernel can be counstructed in different ways", "[OhmicMemoryKernel]")
{
...
TEST_CASE("Ohmic memory kernel obeys crossing relation", "[OhmicMemoryKernel]")
{
