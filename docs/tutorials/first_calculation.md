...
```
The result can be compared to the orange line in Fig. 2 of [this reference](https://link.aps.org/doi/10.1103/PhysRevLett.123.120401), since we have used similar parameters and worked at negligible temperatures (see input file).
